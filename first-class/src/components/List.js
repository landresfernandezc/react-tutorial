...
const List = () => {
    ...
    return (
        <div className="container">
            {
                carList.map((item) => <ListItem key={item.brand} item ={item}> </ListItem>)
            }
        </div>
    )
}
